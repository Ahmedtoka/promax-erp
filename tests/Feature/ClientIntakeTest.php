...
class ClientIntakeTest extends TestCase
{
    ...
    private function payload(array $extra = []): array
    {
        ...
        // ⚠️ **`channel_id` و`price_list_id` إجباريين** (2026-08-08 /
        // 2026-08-07). كانوا ناقصين هنا فكل تيست في الملف كان بيرجّع
        // 422 على خانتين مالهمش علاقة باللي بيتفحص — والفشل بيبان
        // كأنه في الحاجة اللي التيست بيحرسها.
        $base = [
