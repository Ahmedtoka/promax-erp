...
class OpsController extends Controller
{
    ...
    // «الموعود مقابل المتاح» اتشالت بالكامل (قرار المالك ٢٢/٨) —
    // فلو الريفيل الجديد بيرفع أمر تجهيز فوراً فمفيش وعود معلقة.
     ...
     *
     * الراوت `role:admin` — الزرار نفسه محكوم بـ`act.custody.adjust`
     * (أدمن بس، والأدمن يقدر يمنحه).
     *
     * ⭐ **٦/٩/٢٠٢٦: التصحيح تسوية سجل بس — المخزن مايتلمسش.** كل
     * المنطق في `Custody::adjustTo` (الأرضية: مباع + مرجّع + متحوّل).
     * هنا بس: فاليديشن + سبب إجباري + تسجيل الحدث + إشعار المندوب.
     */
