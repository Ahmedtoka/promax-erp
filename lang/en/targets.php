...
return [
    ...
    'month_pct' => 'Pct',
    'manual_badge' => 'Manual',
    'manual_hint' => 'Past months: type a manual actual to override the computed value - leave the box empty to fall back to the system figure. A manager manual actual rolls up into the company total',
    'save_manual' => 'Save manual actuals',
    'manual_saved' => 'Manual actuals saved.',
    'manual_scope' => 'Manual actuals apply to company or manager nodes only.',
    'month_remaining' => 'Remaining',
    'year_total' => 'Year total',
    'total_row' => 'Totals',
    'need_monthly' => 'Needs :amount per month for the rest of the year',
